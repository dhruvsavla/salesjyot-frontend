...
const BankDataTable = ({ columns, apiEndpoint, setData, setSelectedRowData, deleteAPIEndpoint, data, onUpdate }) => {
  ...
  const handleDelete = async (bankId) => {
    ...
    try {
      const endpoint = `${deleteAPIEndpoint}/${bankId}`;
                ...
                <tr {...row.getRowProps()} onClick={() => handleRowClick(row)}>
                  <td>
                    <Button
                      ...
                      onClick={(e) => {
                        e.stopPropagation();
                        handleDelete(row.original.bankId);
                      }}
                    >
                      Delete
                    </Button>
