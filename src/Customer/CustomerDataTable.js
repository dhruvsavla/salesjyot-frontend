...
const CustomerDataTable = ({ columns, apiEndpoint, setData, setSelectedRowData, deleteAPIEndpoint, data, onUpdate }) => {
  ...
  const handleDelete = async (customerId) => {
    ...
    try {
      const endpoint = `${deleteAPIEndpoint}/${customerId}`;
                ...
                <tr {...row.getRowProps()} onClick={() => handleRowClick(row)}>
                  <td>
                    <Button
                      ...
                      onClick={(e) => {
                        e.stopPropagation();
                        handleDelete(row.original.customerId);
                      }}
                    >
                      Delete
                    </Button>
