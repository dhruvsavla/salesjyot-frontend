...
const HSNDataTable = ({ columns, apiEndpoint, setData, setSelectedRowData, deleteAPIEndpoint, data, onUpdate }) => {
  ...
  const handleDelete = async (hsnId) => {
    ...
    try {
      const endpoint = `${deleteAPIEndpoint}/${hsnId}`;
                ...
                <tr {...row.getRowProps()} onClick={() => handleRowClick(row)}>
                  <td>
                    <Button
                      ...
                      onClick={(e) => {
                        e.stopPropagation();
                        handleDelete(row.original.hsnId);
                      }}
                    >
                      Delete
                    </Button>
