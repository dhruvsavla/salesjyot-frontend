...
const RackDataTable = ({ columns, apiEndpoint, setData, setSelectedRowData, deleteAPIEndpoint, data, onUpdate }) => {
  ...
  const handleDelete = async (addRackId) => {
    setDeleting(true); // Set deleting to true during delete operation
    try {
      const endpoint = `${deleteAPIEndpoint}/${addRackId}`;
                ...
                <tr {...row.getRowProps()} onClick={() => handleRowClick(row)}>
                  <td>
                    <Button
                      ...
                      onClick={(e) => {
                        e.stopPropagation();
                        handleDelete(row.original.addRackId);
                      }}
                    >
                      Delete
                    </Button>
