...
const PriceListDataTable = ({ columns, apiEndpoint, setData, setSelectedRowData, deleteAPIEndpoint, data, onUpdate }) => {
  ...
  const handleDelete = async (priceListId) => {
    ...
    try {
      const endpoint = `${deleteAPIEndpoint}/${priceListId}`;
                ...
                <tr {...row.getRowProps()} onClick={() => handleRowClick(row)}>
                  <td>
                    <Button
                      ...
                      onClick={(e) => {
                        e.stopPropagation();
                        handleDelete(row.original.priceListId);
                      }}
                    >
                      Delete
                    </Button>
