...
const AddressDataTable = ({ columns, apiEndpoint, setData, setSelectedRowData, deleteAPIEndpoint, data, onUpdate }) => {
  ...
  const handleDelete = async (addressId) => {
    ...
    try {
      const endpoint = `${deleteAPIEndpoint}/${addressId}`;
                ...
                <tr {...row.getRowProps()} onClick={() => handleRowClick(row)}>
                  <td>
                    <Button
                      ...
                      onClick={(e) => {
                        e.stopPropagation();
                        handleDelete(row.original.addressId);
                      }}
                    >
                      Delete
                    </Button>
